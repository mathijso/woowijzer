        ...
        <div class="bg-white dark:bg-neutral-800 shadow-sm p-8 rounded-xl">
            ...
            <form action="{{ route('woo-requests.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <div class="flex justify-center px-6 pt-5 pb-6 border-2 border-neutral-300 hover:border-blue-400 dark:border-neutral-700 dark:hover:border-blue-600 border-dashed rounded-lg transition">
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-neutral-600 dark:text-neutral-400 text-sm">
                                    <label for="document" class="relative rounded-md focus-within:outline-none font-medium text-blue-600 hover:text-blue-500 cursor-pointer">
