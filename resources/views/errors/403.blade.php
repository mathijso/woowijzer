...
<head>
    ...
    <title>Toegang geweigerd - WooWijzer</title>
                ...
                <section class="py-16 px-4 sm:px-6 lg:px-8">
                    <div class="max-w-7xl mx-auto">
                        <div class="text-center">
                            <!-- Error Code -->
                            <div class="mb-8">
                                <h1 class="text-9xl font-bold text-rijksblauw mb-4">403</h1>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="text-center">
                            ...
                            <div class="grid md:grid-cols-3 gap-6 text-left">
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Controleer uw inloggegevens</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
                                        Zorg ervoor dat u bent ingelogd met de juiste account.
                                    </p>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Controleer uw rechten</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
