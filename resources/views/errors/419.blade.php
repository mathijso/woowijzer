...
<head>
    ...
    <title>Sessie verlopen - WooWijzer</title>
                ...
                <section class="py-16 px-4 sm:px-6 lg:px-8">
                    <div class="max-w-7xl mx-auto">
                        <div class="text-center">
                            <!-- Error Code -->
                            <div class="mb-8">
                                <h1 class="text-9xl font-bold text-rijksblauw mb-4">419</h1>
                            ...
                            <p class="text-lg text-rijksgrijs-6 max-w-3xl mx-auto mb-8">
                                Uw sessie is verlopen vanwege inactiviteit. Dit is een beveiligingsmaatregel 
                                om uw gegevens te beschermen. Probeer de actie opnieuw uit te voeren.
                            </p>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="text-center">
                            ...
                            <div class="grid md:grid-cols-3 gap-6 text-left">
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Sessie timeout</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
                                        Uw sessie is verlopen na een periode van inactiviteit om uw veiligheid te waarborgen.
                                    </p>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Beveiligingsmaatregel</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
                                        Dit voorkomt dat anderen toegang krijgen tot uw account als u de pagina open laat staan.
                                    </p>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Oplossing</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
                                        Log opnieuw in of ga terug naar de hoofdpagina om verder te gaan.
                                    </p>
                                </div>
                            </div>
                            <div class="mt-6">
