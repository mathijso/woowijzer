...
<head>
    ...
    <title>Serverfout - WooWijzer</title>
                ...
                <section class="py-16 px-4 sm:px-6 lg:px-8">
                    <div class="max-w-7xl mx-auto">
                        <div class="text-center">
                            <!-- Error Code -->
                            <div class="mb-8">
                                <h1 class="text-9xl font-bold text-rijksblauw mb-4">500</h1>
                            ...
                            <p class="text-lg text-rijksgrijs-6 max-w-3xl mx-auto mb-8">
                                Er is een onverwachte fout opgetreden op de server. 
                                Onze technici zijn op de hoogte gesteld en werken aan een oplossing.
                            </p>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="text-center">
                            ...
                            <div class="grid md:grid-cols-3 gap-6 text-left">
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Wacht even</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
                                        Probeer over een paar minuten opnieuw. De fout kan tijdelijk zijn.
                                    </p>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Controleer uw verbinding</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
                                        Zorg ervoor dat uw internetverbinding stabiel is.
                                    </p>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-rijksblauw mb-2">Neem contact op</h4>
                                    <p class="text-rijksgrijs-6 text-sm">
