                ...
                <section class="px-4 py-16 sm:px-6 lg:px-8">
                    <div class="mx-auto max-w-7xl">
                        <div class="text-center">
                            <!-- Error Code -->
                            <div class="mb-8">
                                <h1 class="mb-4 text-9xl font-bold text-rijksblauw">500</h1>
                    ...
                    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div class="text-center">
                            ...
                            <div class="grid gap-6 text-left md:grid-cols-3">
                                <div>
                                    <h4 class="mb-2 font-semibold text-rijksblauw">Wacht even</h4>
                                    <p class="text-sm text-rijksgrijs-6">
                                        Probeer over een paar minuten opnieuw. De fout kan tijdelijk zijn.
                                    </p>
                                </div>
                                <div>
                                    <h4 class="mb-2 font-semibold text-rijksblauw">Controleer uw verbinding</h4>
                                    <p class="text-sm text-rijksgrijs-6">
